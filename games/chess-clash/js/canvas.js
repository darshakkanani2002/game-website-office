...
function buildGameCanvas(){
	...
	boardFlipContainer = new createjs.Container();
	...
	boardMovesContainer = new createjs.Container();
	...
	for(var n=0; n<2; n++){
		...
		$.players['gamePlayerHistory'+ n] = new createjs.Text();
		$.players['gamePlayerHistory'+ n].font = "20px bpreplaybold";
		$.players['gamePlayerHistory'+ n].color = '#000';
		$.players['gamePlayerHistory'+ n].textAlign = "center";
		$.players['gamePlayerHistory'+ n].textBaseline='alphabetic';
		$.players['gamePlayerHistory'+ n].text = "";
		$.players['gamePlayerHistory'+ n].y += 12;
		...
		$.players['gamePlayerContainer'+ n].addChild($.players['gamePlayerBg'+ n], $.players['gameIconContainer'+ n], $.players['gamePlayer'+ n], $.players['gameTimer'+ n], $.players['gamePlayerHistory'+ n], $.players['gameTurn'+ n]);
	...
	mainContainer.addChild(logo, logoP, buttonPlayerContainer, buttonLocalContainer, buttonStart);
	if(boardSettings.pieceDrag){
		boardFlipContainer.addChild(boardDesignContainer, boardMovesContainer, boardIconContainer);
	}else{
		boardFlipContainer.addChild(boardDesignContainer, boardIconContainer, boardMovesContainer);
	}
	boardContainer.addChild(boardGuideContainer, boardFlipContainer, statusContainer);
	...
	canvasContainer.addChild(bg, bgP, mainContainer, nameContainer, roomContainer, playersContainer, gameContainer, gameLogsTxt, resultContainer, confirmContainer, optionsContainer, buttonSettings, guideline);
