function html() {
    var O = 'bootstrap',
        ...
        Zb = 'html.devmode.js',
        $b = 'A141A9C5D464FAADB2E3DE64E1A70DD0',
        _b = ':1',
        ac = ':',
        bc = '.cache.js',
        cc = 'link',
        ...
        fc = 'href',
        gc = 'loadExternalRefs',
        hc = 'gwt/chrome/chrome.css',
        ic = 'end',
        jc = 'http:',
        kc = 'file:',
        lc = '_gwt_dummy_',
        mc = '__gwtDevModeHook:html',
    ...
    function A(k) {
        ...
        if (html.__errFn) {
            n.onerror = function() {
                html.__errFn(S, new Error(mb + code))
            }
        }
    ...
    function F() {
        ...
        o.__gwt_activeModules[S].bindings = html.__getPropMap;
        r(O, Yb);
        if (q()) {
            return D(Zb)
        }
    ...
    function G() {
        ...
        function c(a) {
            if (!__gwt_stylesLoaded[a]) {
                var b = p.createElement(cc);
                b.setAttribute(dc, ec);
                b.setAttribute(fc, D(a));
    ...
    B();
    html.__moduleBase = C();
    t[S].moduleBase = html.__moduleBase;
    var H = F();
    if (o) {
