...
window.DOMElementHandler = class extends self.DOMHandler {
    ...
    _OnSetVisible(a) {
        this._autoAttach &&
            (this._elementMap.get(a.elementId).style.display = a.isVisible ? "" : "none")
    }
    _OnUpdatePosition(a) {
        if (this._autoAttach) {
...
window.RuntimeInterface = class a {
    ...
    async _Init(b) {
        ...
        b.runtimeBaseUrl ? this._runtimeBaseUrl = b.runtimeBaseUrl : (c = location.origin, this._runtimeBaseUrl = ("null" === c ? "file:///" : c) + location.pathname, c = this._runtimeBaseUrl.lastIndexOf("/"), -1 !== c && (this._runtimeBaseUrl = this._runtimeBaseUrl.substr(0,
            c + 1)));
    ...
    async _InitWorker(b, c) {
        ...
        let f = b.workerDependencyScripts || [],
            g = b.engineScripts;
        f = await Promise.all(f.map(h =>
            this._MaybeGetCordovaScriptURL(h)));
...
RuntimeInterface$jscomp$1.AddDOMHandlerClass(class extends self.DOMHandler {
    constructor(a) {
        ...
        a.AddRuntimeComponentMessageHandler("runtime", "script-create-worker",
    ...
    Attach() {
        ...
        window.addEventListener("dblclick", b => this._OnMouseEvent("dblclick", b,
            DISPATCH_RUNTIME_AND_SCRIPT));
        ...
        "undefined" !== typeof PointerEvent ? (window.addEventListener("pointerdown", b => {
            ...
            b => this._OnPointerRawUpdate(b))) : window.addEventListener("pointermove", b => this._OnPointerEvent("pointermove", b)), window.addEventListener("pointerup", b => this._OnPointerEvent("pointerup", b)), window.addEventListener("pointercancel", b => this._OnPointerEvent("pointercancel", b))) : (window.addEventListener("mousedown", b => {
            this._HandlePointerDownFocus(b);
            this._OnMouseEventAsPointer("pointerdown", b)
        }), window.addEventListener("mousemove", b => this._OnMouseEventAsPointer("pointermove", b)), window.addEventListener("mouseup",
            b => this._OnMouseEventAsPointer("pointerup", b)), window.addEventListener("touchstart", b => {
            this._HandlePointerDownFocus(b);
    ...
    _OnPointerEvent(a, b) {
        if (!this._isExportToVideo) {
            this._pointerRawUpdateRateLimiter &&
                "pointermove" !== a && this._pointerRawUpdateRateLimiter.Reset();
            var c = 0;
...
self.AudioDOMHandler = class extends self.DOMHandler {
    constructor(a) {
        ...
        self.C3Audio_OnMicrophoneStream = (b, c) => this._OnMicrophoneStream(b,
            c);
    ...
    _AttachUnblockEvents() {
        this._hasAttachedUnblockEvents || (this._hasUnblocked = !1, window.addEventListener("pointerup", this._unblockFunc, !0), window.addEventListener("touchend",
            this._unblockFunc, !0), window.addEventListener("click", this._unblockFunc, !0), window.addEventListener("keydown", this._unblockFunc, !0), this._hasAttachedUnblockEvents = !0)
    }
    ...
    GetDestinationForTag(a) {
        return (a = this._effects.get(a.toLowerCase())) ? a[0].GetInputNode() :
    ...
    async _AddEffect(a) {
        ...
        if ("filter" === b) d = new self.C3AudioFilterFX(this, ...d);
            ...
            d = new self.C3AudioConvolveFX(this,
                b.GetAudioBuffer(), ...d);
        ...
        else if ("distortion" === b) d = new self.C3AudioDistortionFX(this,
            ...d);
    ...
    async _OnLoadState(a) {
        ...
        if (3 !== b) {
            var c = [];
            for (const d of this._audioInstances) d.IsMusic() && 1 === b || !d.IsMusic() && 2 === b ? c.push(d) : d.Release();
        ...
        if (3 !== b) {
            ...
            if (!f || 1 !== b)
                if (f || 2 !== b) {
                    b = null;
                    try {
                        b = await this._GetAudioInstance(c,
                            d, e, g, f)
                    } catch (m) {
...
self.C3AudioInstance = class {
    ...
    SetPan(a, b, c, d, e, f) {
        this._isPannerEnabled && (this.SetPanXYA(a, b, c), a = self.AudioDOMHandler.ToDegrees,
            this._pannerConeParams[0] !== a(d) && (this._pannerConeParams[0] = a(d), this._pannerNode.coneInnerAngle = a(d)), this._pannerConeParams[1] !== a(e) && (this._pannerConeParams[1] = a(e), this._pannerNode.coneOuterAngle = a(e)), this._pannerConeParams[2] !== f && (this._pannerConeParams[2] = f, this._pannerNode.coneOuterGain = f))
    }
    SetPanXYA(a, b, c) {
        if (this._isPannerEnabled) {
            var d = this._pannerPosition,
                ...
                f = Math.cos(c);
            c = Math.sin(c);
            if (d[0] !== a || d[1] !== b || 0 !== d[2]) d[0] = a, d[1] = b, d[2] = 0, this._pannerNode.setPosition(...d);
            if (e[0] !== f || e[1] !== c || 0 !== e[2]) e[0] = f, e[1] = c, e[2] = 0, this._pannerNode.setOrientation(...e)
        }
    }
...
class C3RewardedAd {
    ...
    async Show(a) {
        ...
        if (this._adShowing) return Success$jscomp$3(a,
            "rewarded ad already shown");
        this._adLoading && await this.GetLoadPromise();
        await (async () => {
...
class C3RewardedInterstitialAd {
    ...
    async Show(a) {
        ...
        this._adLoading && await this.GetLoadPromise();
        await (async () => {
            this._loadSuccess ? (_AddShowListeners$jscomp$2.call(this, a), await this._ad.show()) : (_AddLoadListeners$jscomp$3.call(this), this._loadSuccess = !1, this._loadPromise = null, this._ad.load(), await this.GetLoadPromise(), this._loadSuccess ? (_AddShowListeners$jscomp$2.call(this, a), await this._ad.show()) : Failure$jscomp$4(a, "rewarded interstitial ad failed to load"))
        })()
    }
    IsLoading() {
        return this._adLoading
...
addHandler("CreateBannerAdvert", async (a, b, c, d, e) => {
    await C3AdUtils$jscomp$5.StartAdmobPlus(e, c) && (c = await C3Consent$jscomp$1.GetAdPersonalization(), bannerAd || (bannerAd = new C3BannerAd$jscomp$1(a, b, d, e)), bannerAd.Load(c, e))
});
...
addHandler("CreateInterstitialAdvert", async (a, b, c) => {
    if (interstitialAd) return C3AdUtils$jscomp$5.Success(c, "interstitial ad already created");
    await C3AdUtils$jscomp$5.StartAdmobPlus(c, b) && (b = await C3Consent$jscomp$1.GetAdPersonalization(), interstitialAd = new C3InterstitialAd$jscomp$1(a, c), interstitialAd.Load(b, c))
});
...
addHandler("CreateVideoAdvert", async (a, b, c) => {
    if (videoAd || rewardedAd) return C3AdUtils$jscomp$5.Success(c, "video ad already created");
...
addHandler("CreateRewardedAdvert", async (a, b, c) => {
    if (rewardedAd || videoAd) return C3AdUtils$jscomp$5.Success(c, "rewarded ad already created");
...
addHandler("CreateRewardedInterstitialAdvert", async (a, b, c) => {
    if (rewardedInterstitialAd) return C3AdUtils$jscomp$5.Success(c, "rewarded interstitial ad already created");
    await C3AdUtils$jscomp$5.StartAdmobPlus(c, b) && (b = await C3Consent$jscomp$1.GetAdPersonalization(), rewardedInterstitialAd = new C3RewardedInterstitialAd$jscomp$1(a, c), rewardedInterstitialAd.Load(b, c))
});
...
const isReady = async a => {
        ...
        init$jscomp$4 || (self.adsbygoogle = self.adsbygoogle || [], self.adBreak = self.adConfig = b => self.adsbygoogle.push(b), init$jscomp$4 = !0);
...
addHandler$jscomp$2("CreateBannerAdvert", async (a, b, c, d, e) => {
    C3AdUtils$jscomp$6.Failure(e, "banner ads not supported in web platform")
});
