export default class Panel {
    ...
    constructor(scene, x, y, stepsLeft, score) {
        ...
        this.stepsLeftText = scene.add.text(x, y - 210, String(this.stepsLeft), {
                font: "250px ComicHelvetic"
            })
            .setOrigin(0.5);
        this.scoreText = scene.add.text(x, y + 250, 'glasses : ' + String(this.score) + '/100', {
    ...
    addScore(value) {
        ...
        this.score += value;
        this.scoreText
            .setText('glasses : ' + String(this.score) + '/100')
            .setScale(1);
        if (this.bounceTween) {
