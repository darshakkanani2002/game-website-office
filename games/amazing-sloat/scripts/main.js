...
'use strict'; {
    ...
    window.RuntimeInterface = class RuntimeInterface {
        constructor(opts) {
            ...
            if (this.IsAnyWebView2Wrapper()) self["chrome"]["webview"].addEventListener("message",
                e => this._OnWrapperMessage(e.data));
            ...
            this.AddRuntimeComponentMessageHandler("runtime",
                "send-wrapper-extension-message", e => this._OnSendWrapperExtensionMessage(e));
...
'use strict'; {
    ...
    const HANDLER_CLASS = class RuntimeDOMHandler extends self.DOMHandler {
        ...
        _AddDefaultHTMLWrapEventHandlers(htmlwrap) {
            ...
            htmlwrap.addEventListener("touchstart",
                PreventDefaultOnHTMLWrap)
        }
        ...
        Attach() {
            ...
            window.addEventListener("keyup", e => this._OnKeyEvent("keyup",
                e));
        ...
        _OnKeyEvent(name, e) {
            ...
            if (this._iRuntime.IsAnyWebView2Wrapper()) {
                const blockKeys = ["F3", "F5", "F7"];
                const blockKeysWithCtrl = ["r", "p", "f", "g", "u"];
