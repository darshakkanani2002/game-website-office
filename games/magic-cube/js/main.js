// By: elielbony61@gmail.com



//Starting programming  //Compiling the code and converting it into animation for the cubes, to update, add and remove animation.
...
//Building animation  //constructing cube animation echo x and y, to put in their spaces of 2 and 3, forming the cube.
...
function RoundedBoxGeometry(size, radius, radiusSegments) {
    ...
    //pulling parts  //moving the pieces to a certain position in which the block is, at the end of the rotation the block following goes to the opposite position, one after the other.
...
class Cube {
    ...
    constructor(game) {
        ...
        this.game = game;
        //TTT cube configurations //By determining the cube settings, here you can play around to see the possibilities of cube effect.
        this.geometry = {
            pieceSize: 1 / 3,
            pieceCornerRadius: 0.12,
            edgeCornerRoundness: 0.20,
            edgeScale: 0.82,
            edgeDepth: 0.04,
        };
    ...
    //Other configurations//here you can determine the space between the pieces, giving different shape to the cube.
    generateModel() {

        this.pieces = [];
        this.edges = [];

        const pieceSize = 1 / 3; //space between the cubes.
        ...
        // Repositioning the cube //Here when you start the ringing, you will shuffle the cube in a romdamic way, so that the same game is never repeated.
...
class Transition {
    ...
    constructor(game) {
        ...
        this.data = {
            cubeY: -0.2,
            cameraZoom: 0.75, //TTT: zom no cube  //here you determine the size of the cube by increasing or decreasing it by zooming in.
        };
    ...
    float() {
        ...
        this.tweens.float = new Tween({
            ...
            onUpdate: tween => {
                ...
                //		effect sine
                // 		this.game.cube.holder.position.y = (- 0.02 + tween.value * 0.02); 
                this.game.cube.holder.position.y = (-0.00 + tween.value * 0.00);
                this.game.cube.holder.rotation.x = 0.000 - tween.value * 0.00;
    ...
    preferences(show) {
        ...
        ranges.forEach((range, rangeIndex) => {
            ...
            const delay = rangeIndex * (show ? 100 : 100);
...
class Storage {
    ...
    loadPreferences() {
        ...
        this.game.themes.setTheme('cube'); //TTT Change default theme: //Standard theme when starting the game, to edit, simply choose one of these options here: (cube, erno, dust, camo, rain).
    ...
    constructor(game) {
        ...
        this.colors = {
            cube: {
                ...
                B: 0xff8c0a,
                L: 0x82ca38,
                P: 0xc453fc, //border color 08101a
                G: 0x6e34ed,
            },
            erno: {
                U: 0xffffff,
